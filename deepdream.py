...
# Utility functions
def showarray(a, fmt='jpeg', filename=None):
...
def render_lapnorm(t_obj, img0=img_noise, visfunc=visstd,
                   iter_n=10, step=1.0, octave_n=3, octave_scale=1.4, lap_n=4, fileToSave=None):
    t_score = tf.reduce_mean(t_obj) # defining the optimization objective
    t_grad = tf.gradients(t_score, t_input)[0] # behold the power of automatic differentiation!
    ...
    for octave in range(octave_n):
        ...
        for i in range(iter_n):
            ...
            print('.', end = ' ')
        clear_output()
    showarray(visfunc(img), filename=fileToSave)

def render_deepdream(t_obj, img0=img_noise,
                     iter_n=10, step=1.5, octave_n=4, octave_scale=1.4, filename='test.jpg'):
    t_score = tf.reduce_mean(t_obj) # defining the optimization objective
    t_grad = tf.gradients(t_score, t_input)[0] # behold the power of automatic differentiation!
